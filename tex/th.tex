...
(2) Two knives cut the egg surface
(3) Cracking module cuts the incoming egg surface from below with two knives that are aligned in direction of egg focal radius
(4) The knives imitate human  hands work by opening the previously notched egg
(5) The cracked eggs are accumulated  in a movable utensil for optical assessment. 
If the egg yolk appears to be broken, it is removed by an  operator from the processing plant
(6) Cracked eggs are transported by sliding to white and yolk separating module
(7) Separation  is done in a mechanic way while eggs slide over specific shaped  gap that only egg white fills in, while the egg yolks remain intact
