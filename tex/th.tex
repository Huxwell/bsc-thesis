...
W poniższej pracy przedstawiono proces projektowania i tworzenia systemu, które automatycznie przypisuje rozbite jajka kurze do jednej z dwóch poniższych klas:\\
\begin{enumerate}
...
UWAGA Najpierw przebadano. Potem zaprojektowano. Potem zaimplementowano.
że kamera nad rynną w fabryce, że przeprowadziłem badania jakościowe. grupy odbiorców bez pkt. albo w ogóle bez grup odbiorców
